    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/auth/**", "/login", "/", "/home","/quan-ly-chuc-vu","/them-nhan-vien","/phong-ban","/quan-ly-nhan-vien","/chi-nhanh", "/nhom","/api/recruitment/**","/api/attendance/**","/ban-hanh-quyet-dinh","/ho-so-nhan-vien", "/css/**", "/js/**", "/favicon.ico").permitAll()
